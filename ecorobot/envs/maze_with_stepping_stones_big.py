...
class SteppingStoneMazeBig(EcorobotEnv):
    ...
    def add_stepping_stones(self):
        ...
        self.stone_locs = [[self.robot_loc[0]+2.5, self.robot_loc[1] +2],
                           [self.maze_length-1.5, self.robot_loc[1]+2],
                           [self.maze_length - 1.5, self.robot_loc[1]+4],
                           [self.food_loc[0]+ 3, self.food_loc[1]-1.6],
                           [self.food_loc[0]+5, self.food_loc[1]],
                           [self.food_loc[0] + 2.0, self.food_loc[1]+0.5]
    ...
    def build_maze(self):
        ...
        self.wall_specification = {0: {"xml_idx": 0,
                                   ...
                                   4: {"xml_idx": 4,
                                       ...
                                       "loc": [self.food_loc[0] + 0.5, self.food_loc[1] - 1],
                                       "offset": [0, 0],
                                   ...
                                   6: {"xml_idx": 6,
                                       "size": [height, wall_width, 3.5],


                                       "loc": [self.food_loc[0] + 4, self.food_loc[1] - 3],
                                       "offset": [0, 0],
                                   ...
                                   8: {"xml_idx": 8,
                                       "size": [height, wall_width, 2.8],

                                       "loc": [self.maze_length - 2.5, self.maze_length+1],
                                       "offset": [0, 0],
                                       "quat": self.get_wall_quat(-60)
                                       },
                                   }
    ...
    def step_debug(self, state, action, debug_robot_pos):
        ...
        reward_food = jnp.where(jnp.logical_and(at_target, state.info["n_stones"] == len(self.stone_locs)), 10.0,
                                reward_food)
